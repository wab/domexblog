...
if ( have_comments() ) : ?>
  	<h3 id="comments"><?php comments_number('<span>Aucun</span> commentaires', '<span>Un</span> commentaire', '<span>%</span> Commentaires');?></h3>
    ...
    if ( ! comments_open() ) : // There are comments but comments are now closed
        echo"<p class='nocomments'>Les commentaires sont fermés</p>";
    endif;
...
comment_form(array(
  ...
  'comment_field' => '<p class="comment-form-comment"><label for="comment">Message</label>
<span class="required">*</span><textarea name="comment" id="comment" cols="45" rows="10" tabindex="4" aria-required="true"></textarea></p>',
  'label_submit' => 'Poster',
  'comment_notes_after' => ''
  ));
